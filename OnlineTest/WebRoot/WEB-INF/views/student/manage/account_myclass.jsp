		...
		<script type="text/javascript">
			$(function(){
				$(".deleteEX").click(function(){
					if(confirm("是否删除改试卷，此操作无法恢复！！！")){
						$(this).next().submit();
						/* ${pageContext.request.contextPath }/student/manage/deleteEX?Spid=${sp1.getSpid() } */
					}
				});
				...
				<div id="class">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div id="cz111" class="panel-items">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="deleteEX" id="deleteEX">删除试卷</a>
									<form id="deleteEXfr" method="post" action="${pageContext.request.contextPath }/student/manage/deleteEX">
										<input type="hidden" name="spid" value="${sp1.getSpid() }"/>
									</form>
								</div><br/>
